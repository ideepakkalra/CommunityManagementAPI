...
insert into t_community_referral (id, version, code, referrer_id, phone_number, state, updated_by_id, updated_on) values (0, 0, 'e3f2d82b-2859-4d0f-a2e7-5c8bc7fee333', 0, '+10000000000', 0, 0, '1900-01-01');